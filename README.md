...
- **เลื่อนทีละฉาก**: ฉากจะเริ่มเล่นเมื่อเลื่อนมาถึงกลางจอจริง ๆ (ไม่ใช่แค่ขอบบนโผล่)
  และฉากเล่าเรื่องที่สูงหนึ่งจอจะ snap ให้หยุดตรงหัวฉาก
  ปรับได้ที่ `rootMargin` ใน `main.js` และบล็อก SCROLL RHYTHM ใน `home.css`
