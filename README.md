...
- **เพลงพื้นหลัง**: เล่นตอนกด "Enter Our Story" วนซ้ำอัตโนมัติเมื่อจบเพลง
  มีปุ่มเปิด/ปิดเสียงมุมบนขวาของหน้าแรก และจำค่าที่เลือกไว้ข้ามหน้า
...
- **โหมดเต็มจอ** (ปุ่มมุมบนขวาของต้นไม้ — ใช้ฉายบนจอในวันงาน):
  ซ้ายเป็นต้นไม้กับการ์ดคำอวยพรที่มีทั้งรูปและข้อความสลับขึ้นมาทุก 5 วินาที
  ขวาเป็นแถบลำดับคำอวยพรทั้งหมด เรียงใหม่→เก่า กดที่รายการเพื่อฉายข้อความนั้นได้
  ดึงคำอวยพรใหม่ทุก 45 วินาทีอัตโนมัติ
